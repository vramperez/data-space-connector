...
However, the Mongo image being used is the latest secured version, since the one from the bitnamilegacy repository does not support the ARM architecture.
